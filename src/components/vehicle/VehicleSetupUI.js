...
import { radius, typography } from '../../theme/brandV2';
...
export const styles = StyleSheet.create({
  ...
  safe: { flex: 1, backgroundColor: brand.bg }, scroll: { paddingHorizontal: 16, paddingBottom: 120 }, title: { ...typography.h1, color: brand.textPrimary, marginTop: 16, marginBottom: 8 }, subtitle: { ...typography.bodyLarge, color: brand.textSecondary, marginBottom: 20 }, labelRow: { flexDirection: 'row', alignItems: 'baseline', marginBottom: 8, marginTop: 14 }, label: { ...typography.bodyLarge, color: brand.textPrimary, fontWeight: '700' }, optional: { ...typography.bodySmall, color: brand.textSecondary }, select: { minHeight: 52, borderWidth: 1, borderColor: brand.borderStrong, borderRadius: 10, flexDirection: 'row', alignItems: 'center', paddingRight: 12, backgroundColor: brand.surface }, iconBox: { width: 48, minHeight: 50, alignItems: 'center', justifyContent: 'center', borderRightWidth: 1, borderRightColor: brand.divider }, selectText: { flex: 1, paddingHorizontal: 12, ...typography.bodyLarge, color: brand.textPrimary, fontWeight: '600' }, empty: { color: 'transparent' }, input: { minHeight: 52, borderWidth: 1, borderColor: brand.borderStrong, borderRadius: 10, paddingHorizontal: 14, ...typography.bodyLarge, color: brand.textPrimary, backgroundColor: brand.surface }, row: { flexDirection: 'row', gap: 10 }, footer: { position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: brand.bg, paddingHorizontal: 16, paddingTop: 10, paddingBottom: 16, borderTopWidth: 1, borderTopColor: brand.divider }, cta: { minHeight: 46, borderRadius: 10, backgroundColor: brand.primary, alignItems: 'center', justifyContent: 'center' }, ctaDisabled: { backgroundColor: '#D8DEE5' }, ctaText: { ...typography.button, color: brand.textOnPrimary }, disabledText: { color: brand.textTertiary }, search: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: brand.surfaceMuted, borderRadius: 10, paddingHorizontal: 12, marginBottom: 8 }, searchInput: { flex: 1, minHeight: 44, ...typography.body, color: brand.textPrimary }, option: { minHeight: 52, paddingHorizontal: 8, flexDirection: 'row', alignItems: 'center', gap: 12, borderBottomWidth: 1, borderBottomColor: brand.divider }, optionSelected: { backgroundColor: brand.primarySoft }, optionText: { flex: 1, ...typography.bodyLarge, color: brand.textPrimary }, iso: { ...typography.caption, color: brand.textTertiary }, emptyState: { ...typography.body, color: brand.textSecondary, padding: 20, textAlign: 'center' }, error: { color: brand.errorText, ...typography.bodySmall, marginTop: 8 }, reviewCard: { backgroundColor: brand.surfaceSoft, borderRadius: 14, padding: 14, marginBottom: 12 }, reviewHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 10 }, reviewTitle: { flex: 1, ...typography.h2, fontSize: 18, color: brand.textPrimary }, edit: { color: brand.primary, fontWeight: '700' }, reviewRow: { flexDirection: 'row', marginTop: 8 }, reviewKey: { width: '48%', ...typography.bodySmall, color: brand.textSecondary }, reviewValue: { flex: 1, ...typography.body, color: brand.textPrimary, fontWeight: '600' }, successCircle: { width: 72, height: 72, borderRadius: 36, backgroundColor: brand.primary, alignItems: 'center', justifyContent: 'center', borderWidth: 8, borderColor: brand.primarySoft }, benefit: { flex: 1, minHeight: 80, backgroundColor: brand.surfaceSoft, borderRadius: 10, alignItems: 'center', justifyContent: 'center', padding: 8 }, benefitText: { ...typography.caption, color: brand.textSecondary, textAlign: 'center', marginTop: 6 }, secondary: { minHeight: 46, borderRadius: 10, borderWidth: 1, borderColor: brand.primary, alignItems: 'center', justifyContent: 'center', marginTop: 8 }, secondaryText: { ...typography.button, color: brand.primary },
});
