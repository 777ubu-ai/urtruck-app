...
export function CountrySheet({ visible, onClose, onSelect, title }) {
  ...
  return <BottomSheet visible={visible} onClose={() => { setQuery(''); onClose(); }} title={title} scroll={false}>
    ...
    <FlatList
      ...
      ListEmptyComponent={<Text style={styles.emptyState}>{getVehicleCopy(lang).noCountries}</Text>}
    />
  </BottomSheet>;
}
...
export const styles = StyleSheet.create({
  ...
  title: { ...typography.h1, color: brand.textPrimary, marginTop: 16, marginBottom: 8 },
  subtitle: { ...typography.bodyLarge, color: brand.textSecondary, marginBottom: 20 },
  labelRow: { flexDirection: 'row', alignItems: 'baseline', marginBottom: 8, marginTop: 14 },
  label: { ...typography.bodyLarge, color: brand.textPrimary, fontWeight: '700', flexShrink: 1 },
  optional: { ...typography.bodySmall, color: brand.textSecondary },
  ...
  dimensionGrid: { flexDirection: 'row', flexWrap: 'wrap', columnGap: 10 },
  ...
  searchInput: { flex: 1, minHeight: 44, ...typography.body, color: brand.textPrimary },
  countryList: { maxHeight: 480 },
  option: { minHeight: 52, paddingHorizontal: 8, flexDirection: 'row', alignItems: 'center', gap: 12, borderBottomWidth: 1, borderBottomColor: brand.divider },
  optionSelected: { backgroundColor: brand.primarySoft },
  optionText: { flex: 1, ...typography.bodyLarge, color: brand.textPrimary },
  iso: { ...typography.caption, color: brand.textTertiary },
  ...
  benefitText: { ...typography.caption, color: brand.textSecondary, textAlign: 'center', marginTop: 6 },
  secondary: { minHeight: 46, borderRadius: 10, borderWidth: 1, borderColor: brand.primary, alignItems: 'center', justifyContent: 'center', marginTop: 8 },
