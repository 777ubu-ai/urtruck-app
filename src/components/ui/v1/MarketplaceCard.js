    ...
    >
      ...
      {body || status || rightMeta || bookmark || unread > 0 ? (
        <View style={s.bottomRow}>
          ...
          {bookmark ? <BookmarkButton saved={bookmark.saved} onPress={bookmark.onToggle} icon={bookmark.icon} testID={bookmark.testID} accessibilityLabel={bookmark.accessibilityLabel} /> : null}
        </View>
      ) : null}
      {children}
    </Card>
