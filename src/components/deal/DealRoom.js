...
const s = StyleSheet.create({
  ...
  qaRow: { flexDirection: 'row', gap: 8, paddingHorizontal: 4, paddingBottom: 6 },
  qa: { flex: 1, borderWidth: 1, borderRadius: 12, paddingVertical: 8, alignItems: 'center', gap: 4 },
  qaText: { fontSize: 9, fontWeight: '700', textAlign: 'center' },
  docs: { borderWidth: 1, borderStyle: 'dashed', borderRadius: 12, padding: 12, marginBottom: 8, gap: 4 },
  docsHead: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  docsTitle: { fontSize: 13, fontWeight: '800' },
  docsHint: { fontSize: 11 },
});
