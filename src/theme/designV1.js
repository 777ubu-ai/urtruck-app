...
import { LIGHT as PALETTE_LIGHT, DARK as PALETTE_DARK, DRIVER_CERAMIC, withAlpha } from './designV1Palette';

// Named aliases keep the legacy token contract readable to tooling while the
// palette remains the single source of truth.
const LIGHT = { bg: '#F6F8F7', ...PALETTE_LIGHT };
const DARK = { bg: '#0F1512', ...PALETTE_DARK };
export { LIGHT, DARK };
