...
export const DARK = {
  ...
  // ── BottomNav canon restore (2026-09-13): the focused tab (icon + label,
  //  both roles now share one state — see BottomNav.js) uses `driverDeep`
  //  on LIGHT, but that same dark green measures only ~2.8:1 on DARK.bg —
  //  one value can't serve both themes here either. This is the same
  //  "statusAccepted" green family, shifted for dark-surface legibility
  //  (6.9:1 on DARK.bg, 5.7:1 on the translucent driverSoft pill).
  navActiveOnDark: '#3BB273',
