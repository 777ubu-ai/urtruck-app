...
const s = StyleSheet.create({
  ...
  cpRoute: { fontSize: 11, marginTop: 5 },
  ...
  heroLabel: { fontSize: 12, fontWeight: '750' },
  ...
  swipeHint: { fontSize: 11, fontWeight: '650' },
  ...
  dateState: { fontSize: 10, fontWeight: '700', textAlign: 'center', marginTop: 3 },
  dateAmount: { fontSize: 9, lineHeight: 11, fontWeight: '700', textAlign: 'center', marginTop: 2 },
  ...
  lookupText: { fontSize: 12, lineHeight: 19 },
});
