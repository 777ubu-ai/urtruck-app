...
const s = StyleSheet.create({
  ...
  photoIcon: { fontSize: 16, color: v1Colors.textMuted, width: 20, textAlign: 'center' },
  photoLabel: { color: v1Colors.text, fontSize: 13, fontWeight: '700' },
  photoSub: { color: v1Colors.textMuted, fontSize: 11, marginTop: 2 },
