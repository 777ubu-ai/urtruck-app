...
const s = StyleSheet.create({
  ...
  liveMiniText: { fontSize: 12, fontWeight: '800' },
  routeMetrics: {
    position: 'absolute',
    left: 12,
    right: 12,
  ...
  planHint: { fontSize: 12, lineHeight: 16, marginTop: 2 },
  ...
  statLbl: { fontSize: 11, fontWeight: '700', marginTop: 2, textTransform: 'uppercase', letterSpacing: 0.3, textAlign: 'center' },
