      ...
      {loading ? (
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={[s.stats, { backgroundColor: theme.card, borderColor: theme.border }]}>
            ...
            <View style={s.stat}>
              <Text style={[s.statNum, { color: moving ? '#168A5B' : theme.textMuted }]}>{(!isStale && speedKmh != null) ? speedKmh : '—'}</Text>
          ...
          <View style={s.subRow}>
            {nearBorder && !isStale ? (
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
                <Feather name="flag" size={12} color="#168A5B" />
...
const s = StyleSheet.create({
  ...
  badgeBorder: { color: '#168A5B', fontSize: 12, fontWeight: '800' },
