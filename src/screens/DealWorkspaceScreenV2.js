...
const s = StyleSheet.create({
  ...
  routeTitle: { flex: 1, fontSize: 14, fontWeight: '900', letterSpacing: -0.05 },
  ...
  systemText: { fontSize: 12, fontWeight: '650', paddingHorizontal: 10, paddingVertical: 5, backgroundColor: 'rgba(124,139,130,0.12)', borderRadius: 999 },
