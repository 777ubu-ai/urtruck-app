...
const styles = StyleSheet.create({
  ...
  routeLabel: { fontSize: 12, lineHeight: 15, fontWeight: '600' },
  ...
  route: { fontSize: 16, lineHeight: 20, fontWeight: '700', letterSpacing: -0.1, flexShrink: 1 },
  ...
  price: { fontSize: 16, lineHeight: 20, fontWeight: '800' },
  perTrip: { fontSize: 12, lineHeight: 15, marginTop: 1 },
  bookmarkBtn: {
    position: 'absolute',
    right: 8,
    bottom: 8,
