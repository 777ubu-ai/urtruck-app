...
const styles = StyleSheet.create({
  ...
  selectorHint: { marginTop: 3, fontSize: 12, lineHeight: 16 },
  ...
  countryMeta: { marginTop: 4, fontSize: 12 },
  ...
  bestBadgeText: { color: '#168759', fontSize: 11, fontWeight: '800' },
  ...
  metricLabel: { fontSize: 12, lineHeight: 16, marginBottom: 5 },
  ...
  input: { flex: 1, fontSize: 14, marginLeft: 8, paddingVertical: 9 },
  ...
  primaryButtonText: { color: '#fff', fontSize: 14, fontWeight: '850' },
  ...
  plate: { fontSize: 16, fontWeight: '900', letterSpacing: 0.4 },
  ...
  savedPlateText: { fontSize: 12, fontWeight: '800' },
  ...
  retryText: { color: '#168759', fontWeight: '800', fontSize: 12 },
  ...
  portalText: { color: '#168759', fontWeight: '800', fontSize: 12 },
  ...
  detailLabel: { fontSize: 12, flex: 0.44 },
  detailValue: { fontSize: 13, fontWeight: '800', flex: 0.56, textAlign: 'right' },
  dataNote: { marginTop: 4, fontSize: 12, lineHeight: 17 },
