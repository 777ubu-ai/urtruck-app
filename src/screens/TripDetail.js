      ...
      <SafeAreaView style={[s.container, { backgroundColor: theme.bg }]} edges={['top']}>
        <View style={s.header}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
            <Feather name="truck" size={20} color="#168A5B" />
            <GradientText style={s.title} colors={['#168A5B', '#16A34A']}>{t('trip_title')}</GradientText>
          </View>
        </View>
    ...
    <SafeAreaView style={[s.container, { backgroundColor: v1.bg }]} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={{ padding: 16, paddingTop: 0, paddingBottom: 96 + insets.bottom }}>
        ...
        <GlassCard>
          ...
          <View style={s.routeRow}>
            <View style={[s.dot, { backgroundColor: '#168A5B' }]} />
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                <View style={{ flex: 1, marginRight: 8 }}>
                  ...
                  <Text style={{
                    ...
                    color: b.status === 'accepted' ? '#168A5B' : isCountered ? '#E06D00' : '#FBBF24',
                  }}>
