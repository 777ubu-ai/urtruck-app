...
// I18N-16 (2026-09-12): extended from RU/EN/ZH/KK to all 16 supported
// UI locales (feat/claude-i18n-16-locales-20260912) — without this, a
// German/French/Polish/etc. user's vehicle-country picker fell through to
// the 'ru-RU' default and showed Russian country names in an otherwise
// non-Russian UI (item 2/item 11: formatters must be locale-safe, no
// silent Russian leak for international users). Falls back to English
// (not Russian) for any UI locale Intl.DisplayNames doesn't recognize.
const COUNTRY_NAME_LOCALE = {
  RU: 'ru-RU', EN: 'en-US', ZH: 'zh-CN', KK: 'kk-KZ',
  UZ: 'uz-UZ', KY: 'ky-KG', TG: 'tg-TJ', DE: 'de-DE',
  FR: 'fr-FR', PL: 'pl-PL', LT: 'lt-LT', LV: 'lv-LV',
  IT: 'it-IT', TR: 'tr-TR', BE: 'be-BY', RO: 'ro-RO',
};

const localizedCountryName = (iso, lang = 'RU') => {
  try {
    const locale = COUNTRY_NAME_LOCALE[lang] || 'en-US';
