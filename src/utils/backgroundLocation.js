...
//   - start/stop дергается из useDealLocationBroadcast: есть сделки в
//     работе → просим разрешение «Всегда» и стартуем; сделок нет → стоп.
...
export async function startBackgroundTracking() {
  ...
  try {
    ...
    await Location.startLocationUpdatesAsync(BG_LOCATION_TASK, {
      ...
      foregroundService: {
        notificationTitle: 'UrTruck — рейс в пути',
        notificationBody: 'Передаём позицию машины грузоотправителю',
      },
    });
    return { ok: true };
  } catch (e) {
