...
- Heart favorites were replaced with outline/filled bookmark states.
  **Owner-confirmed 2026-08-19** as the canonical icon (a same-day attempt
  to "fix" this back to heart, chasing a visual-inconsistency report, was
  itself reverted — `FavoritesScreen` was the odd one out using heart and
  is now bookmark too). See `tests/frontend/shipper_cards_unified.test.mjs`
  and `qa/utils/favoritesContractSmoke.js`.
