...
// Commit 8: QueueScreenLazy.js was deleted — QueueScreenLazyV2.js is the
// live driver-first border screen.
...
assert.ok(screen.includes('checkpointCarouselRef') && screen.includes('scrollTo'), 'Carousel next control must move the checkpoint list');
