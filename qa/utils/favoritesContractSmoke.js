...
// scheduled for Commit 8). The bookmark icon canon this smoke used to pin on
// FeedCard is repointed to MarketplaceCard.js — same intent, live component.
...
assert.ok(/name="bookmark"/.test(marketplaceCard), 'MarketplaceCard bookmark icon required');
assert.ok(!/name="heart"/.test(marketplaceCard), 'MarketplaceCard must not regress to a heart icon');
