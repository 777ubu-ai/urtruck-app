...
from api.verification_gate import require_level, require_active_level, get_user, _extract_driver, require_role
...
def create_trip(
    body: TripIn,
    user=Depends(require_active_level(1)),
    ...
    require_role(user, ("driver",), "разместить рейс")
    if not body.from_city or not body.to_city:
