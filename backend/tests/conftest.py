...
from api import verification_gate as _verification_gate
_canonical_require_level = _verification_gate.require_level
...
def _reassert_schema_before_each_test(_ensure_full_schema):
    ...
    _rebuild_all_schemas()
    _verification_gate.require_level = _canonical_require_level
    yield
