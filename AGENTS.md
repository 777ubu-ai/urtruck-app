...
Никогда не сокращать доказательства: сохранять PASS/FAIL, SHA, версии, устройства,
точные ошибки, риски и release blockers. Для security, необратимых действий,
релизных инструкций и сложного debugging давать столько деталей, сколько нужно
для безопасного решения.

Пользовательские и маркетинговые тексты писать естественно: без шаблонного
AI-пафоса, повторов и выдуманных фактов. Код, SQL, JSON, API-контракты, логи и
тестовые результаты не "очеловечивать".
