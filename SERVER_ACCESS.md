...
| Старые пароли | ❌ **Не использовать и не хранить в репозитории** |
| sshpass | ❌ **Бесполезен** |
...
Аварийные пароли и ключи не хранятся в репозитории. Доступ к консоли хостинга
(VNC/KVM) и аварийные данные должны находиться только в менеджере паролей у
владельцев проекта. При любом подозрении на раскрытие доступов их нужно сразу
сменить через панель хостинга.
...
Админка:     http://185.22.65.11:8001/admin (учётные данные — только в менеджере паролей)
