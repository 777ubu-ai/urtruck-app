...
## Демо-доступ для ревьюера (для формы App Review)
- Вход: **Email** → `appreview@urtruck.kz`
- Код из письма/демо: **1975**
- (бэкенд отдаёт этот код без реальной отправки только для ревьюерского аккаунта)
