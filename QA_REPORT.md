...
| P1-6 глобальный 401 | ⏸ отложено осознанно | авто-логаут из дата-слоя без аккуратного отличения 401 от сетевого сбоя → риск цикла разлогина (регрессия P0). Нужен дизайн + device-тест |
| P1-8 setState-after-unmount | ⏸ отложено осознанно | широкая правка по десяткам экранов; warning, не краш. Делать пакетно через общий `useMountedRef` с прогоном регрессии |
